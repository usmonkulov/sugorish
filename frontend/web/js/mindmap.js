    ...
    var methods = {
        init: function( options ) {
            ...
            $(document).on('keydown', function(event) {
                ...
                switch(key) {
                    ...
                    // Esc
                    case 27:
                        // Ð’Ð¾Ð·Ð²Ñ€Ð°Ñ‰Ð°ÐµÐ¼ Ð¿ÐµÑ€Ð²Ð¾Ð½Ð°Ñ‡Ð°Ð»ÑŒÐ½Ð¾Ðµ Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ðµ, Ð±Ð»ÑŽÑ€Ð¸Ð¼
                        break;
        ...
        balance: function() {
            if (params.balance) {
                ...
                // Ð§Ð¸Ð½Ð¸Ð¼ Ð¿Ñ€Ð°Ð²ÑƒÑŽ Ð²ÐµÑ‚ÐºÑƒ, ÐµÑÐ»Ð¸ ÐµÐµ Ð½Ðµ ÑÑƒÑ‰ÐµÑÑ‚Ð²ÑƒÐµÑ‚
                if (!rBranch.length) {
                    ...
                    if (freeBranch.length) {
                        ...
                        if (rootBranches.length) {
                            ...
                            return; // ÐÐµÑ‚ Ð½Ð¸ Ð¾Ð´Ð½Ð¾Ð¹ Ð²ÐµÑ‚ÐºÐ¸
                        }
                    }
                }

                // Ð§Ð¸Ð½Ð¸Ð¼ Ð»ÐµÐ²ÑƒÑŽ Ð²ÐµÑ‚ÐºÑƒ, ÐµÑÐ»Ð¸ ÐµÐµ Ð½Ðµ ÑÑƒÑ‰ÐµÑÑ‚Ð²ÑƒÐµÑ‚
                if (!lBranch.length) {
