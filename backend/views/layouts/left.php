        ...
        <?= dmstr\widgets\Menu::widget(
            [
                ...
                'items' => [
                    ...
                    ['label' => 'Shop', 'options' => ['class' => 'active'], 'icon' => 'folder', 'items' => [
                    ...
                    ['label' => 'Blog', 'options' => ['class' => 'active'], 'icon' => 'folder', 'items' => [
                    ...
                    ['label' => 'Content', 'options' => ['class' => 'active'], 'icon' => 'folder', 'items' => [
