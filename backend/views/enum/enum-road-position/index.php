    ...
    <div class="box box-info">
        ...
        'columns' => [
            ...
            [
                ...
                'format' => 'html',
                'value' => function ($data) {
                    return Html::a($data->title_uz, ['enum-road-position/view/', 'id' => $data->id]);
                }
            ],
            'code_name',
            ...
            [
                ...
                'value'     => function ($data) {
                    if ($data->id) {
                        return EnumRoadPositionStatus::getStatusHtml($data, 'index');
                    }
                },
                'filter'    =>  ArrayHelper::map(EnumRoadPositionStatus::getStatusForSelect(), 'id', 'value'),
            ],
